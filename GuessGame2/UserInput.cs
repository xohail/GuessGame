...
public class UserInput : IUserInput
{
    ...
    {
        DisplayInformation.DisplayMessage(
    ...
    {
        DisplayInformation.DisplayMessage("\u001b[1mChoose the difficulty level\u001b[0m",
            "1) 1 to 5   Easy",
            "2) 1 to 10  Medium",
            "3) 1 to 20  Hard"
        );
    ...
    {
        DisplayInformation.DisplayMessage($"\u001b[1mEnter your guess from {range[0]} to {range[1]} \u001b[0m");
