...
public class ValidateInputTests
{
    ...
    public void ValidateIntAndNotZero_InputValid_ReturnsParsedValue()
    {
        ...
        // Act
        var result = _validateInput.ValidateIntAndNotZero(input);
    ...
    {
        // Act
        var result = _validateInput.ValidateDifficultyValue(input);
    ...
    {
        // Act
        var result = _validateInput.ValidateGuessValue(input, range);
